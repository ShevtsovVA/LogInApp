...
class ViewController: UIViewController {
    ...
    func alert (title:String?,message: String?) {
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("Try once more", comment: "Default action"), style: .default, handler: { _ in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        helloScreenVC.helloLabel = userNameTF.text
    }
